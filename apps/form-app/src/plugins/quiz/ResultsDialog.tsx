        ...
        <div className="space-y-6 mt-4">
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-6 border border-[var(--tf-border-medium)]">
            <div className="flex items-center justify-between mb-4">
              ...
              <Badge variant={passed ? 'default' : 'destructive'} className="text-base px-4 py-1.5">
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">{metadata.quizScore}</div>
              ...
              <div className="text-center border-x border-[var(--tf-border-strong)]">
                <div className="text-3xl font-bold text-primary">{metadata.percentage.toFixed(1)}%</div>
                <div className="text-sm text-foreground mt-1">{t('percentage')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">{correctAnswers}/{totalQuestions}</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2">
                      <div className={cn('text-sm p-3 rounded-lg', result.isCorrect ? 'bg-green-100 text-green-800' : 'bg-[var(--tf-error-bg)] text-destructive')}>
