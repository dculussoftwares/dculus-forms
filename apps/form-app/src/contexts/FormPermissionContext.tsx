...
export interface FormPermissionContextType {
...
const FormPermissionContext = createContext<FormPermissionContextType | undefined>(undefined);
...
export const FormPermissionProvider: React.FC<FormPermissionProviderProps> = ({
  ...
  const canManageSharing = userPermission === 'OWNER' || userPermission === 'EDITOR';
