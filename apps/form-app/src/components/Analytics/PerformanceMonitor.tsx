          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 border rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-foreground">{t('cards.hitRatio.title')}</span>
              </div>
            ...
            <div className="p-4 border rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-foreground">{t('cards.cacheEntries.title')}</span>
              </div>
            ...
            <div className="p-4 border rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-foreground">{t('cards.memory.title')}</span>
              </div>
