...
const EmptyState = ({ icon: Icon, title, subtitle }: { 
  ...
  <div className="h-48 flex flex-col items-center justify-center text-muted-foreground">
    <Icon className="h-10 w-10 mb-3 text-[var(--tf-light-muted)]" />
                  ...
                  <div key={os.name} className="flex items-center justify-between py-1">
                    ...
                    <div className="text-right">
                      {dataMode === 'combined' ? (
                        ...
                        <>
                          <span className="text-sm font-medium text-primary">{os.count}</span>
                          <span className="text-xs text-muted-foreground ml-2">
                  ...
                  <div key={browser.name} className="flex items-center justify-between py-1">
                    ...
                    <div className="text-right">
                      {dataMode === 'combined' ? (
                        ...
                        <>
                          <span className="text-sm font-medium text-primary">{browser.count}</span>
                          <span className="text-xs text-muted-foreground ml-2">
