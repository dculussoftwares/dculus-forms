...
const AnalyticsEmptyState: React.FC<{
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <h3 className="text-lg font-semibold text-primary mb-2">{message}</h3>
      {description && (
...
const AnalyticsErrorState: React.FC<{
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      <div className="rounded-full bg-[var(--tf-error-bg)] p-6 mb-4">
        <FileText className="h-12 w-12 text-destructive" />
      </div>
      <h3 className="text-lg font-semibold text-primary mb-2">Error Loading Analytics</h3>
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-semibold text-primary">{fieldLabel}</h2>
