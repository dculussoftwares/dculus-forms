        ...
        <div className="relative h-32 bg-[#e8f0fe] rounded-lg p-4">
          ...
          <div className="relative h-16">
            ...
            <div className="absolute bottom-0 w-full">
              <div 
                className="absolute text-xs text-center text-foreground"
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="space-y-2">
              <h4 className="font-medium text-primary">{t('summary.centralTendency')}</h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span className="text-foreground">{t('summary.mean')}</span>
                  <span className="font-medium">{formatNumber(data.average)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-foreground">{t('summary.median')}</span>
            ...
            <div className="space-y-2">
              <h4 className="font-medium text-primary">{t('summary.spread')}</h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span className="text-foreground">{t('summary.range')}</span>
                  <span className="font-medium">{formatNumber(data.max - data.min)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-foreground">{t('summary.stdDev')}</span>
            ...
            <div className="space-y-2">
              <h4 className="font-medium text-primary">{t('summary.quartiles')}</h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span className="text-foreground">{t('summary.q1')}</span>
                  <span className="font-medium">{formatNumber(data.percentiles.p25)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-foreground">{t('summary.q3')}</span>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-foreground">{t('summary.skewness')}</span>
