  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-hidden" data-testid="filter-modal">
          ...
          <div>
            ...
            {activeFilterCount > 1 && (
              <div className="mt-3 flex items-center gap-2">
                <span className="text-xs text-foreground font-medium">Match:</span>
          ...
          <div className="space-y-4">
            ...
            {activeFilters.length > 0 ? (
              ...
              <div className="text-center py-12">
                <div className="text-muted-foreground text-lg mb-4">{t('emptyState.title')}</div>
            ...
            <div className="flex items-center justify-center pt-4">
              <Button
                ...
                className="text-foreground hover:text-primary border-dashed border-2 hover:border-solid hover:border-[var(--tf-border-strong)]"
        ...
        {/* Footer with actions */}
        <div className="flex items-center justify-between p-6 border-t border-[var(--tf-border-medium)] bg-white">
