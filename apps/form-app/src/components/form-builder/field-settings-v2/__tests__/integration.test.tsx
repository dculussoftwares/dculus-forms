...
jest.mock('../../field-settings', () => ({
  ValidationSummary: ({ errors }: any) => <div data-testid="validation-summary">{JSON.stringify(errors)}</div>,
  ...
  OptionsSettings: () => <div data-testid="options-settings">Options Settings</div>,
  RichTextSettings: () => <div data-testid="rich-text-settings">Rich Text Settings</div>,
...
describe('FieldSettingsV2 Integration', () => {
  ...
  describe('Field Type Routing', () => {
    ...
    test('routes to TextFieldSettings for text input field', () => {
      ...
      expect(screen.getByTestId('field-settings-header')).toHaveTextContent('Test Text Field');
    ...
    test('routes to NumberFieldSettings for number field', () => {
      ...
      // Should render field settings header with field label
      expect(screen.getByTestId('field-settings-header')).toHaveTextContent('Test Number Field');
    ...
    test('routes to SelectionFieldSettings for select field', () => {
      ...
      // Should render field settings header with field label
      expect(screen.getByTestId('field-settings-header')).toHaveTextContent('Test Select Field');
