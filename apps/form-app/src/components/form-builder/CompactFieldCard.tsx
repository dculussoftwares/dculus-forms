  ...
  const getVariantStyles = () => {
    switch (variant) {
      ...
      default:
        ...
        return {
          container:
            'h-[52px] border-2 border-dashed border-[var(--tf-border-strong)] dark:border-gray-600 bg-background dark:bg-gray-800/50 hover:border-gray-400 dark:hover:border-gray-500',
          content: '',
        };
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {showLabel && (
          <>
            <span className="flex-shrink-0 text-muted-foreground dark:text-gray-500">
              •
            </span>
            <span
              className={cn(
