                    ...
                    <div className="flex-1 min-w-0">
                        {isEditingTitle && permissions.canEdit ? (
                            <Input
                                ...
                                className="h-8 text-sm font-medium border-0 shadow-none p-0 focus:ring-0 focus:border-transparent bg-transparent w-full"
                                style={{ color: '#3c323e' }}
                                autoFocus
                            />
                        ) : (
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                        {isLoading ? (
                            <>
                                ...
                                <span className="text-xs" style={{ color: '#655d67' }}>{t('status.connecting')}</span>
                            </>
                        ) : isConnected ? (
                            <>
                                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#177767' }} />
                                <span className="text-xs font-medium" style={{ color: '#177767' }}>{t('status.live')}</span>
                            </>
                        ) : (
                            <>
                                <div className="w-2 h-2 bg-red-400 rounded-full" />
                                <span className="text-xs" style={{ color: '#655d67' }}>{t('status.offline')}</span>
                            </>
                        )}
                        <PermissionBadge />
                    </div>
