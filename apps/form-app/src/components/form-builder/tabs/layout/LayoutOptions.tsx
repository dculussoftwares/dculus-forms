    ...
    <div>
      ...
      <div className="space-y-2 text-sm">
        <div className="flex justify-between items-center">
          <span className="text-foreground dark:text-gray-400">{t('labels.current')}</span>
          <span className="text-primary dark:text-white font-mono">
            {currentLayoutCode}
          </span>
        </div>
        <div className="flex justify-between items-center">
          <span className="text-foreground dark:text-gray-400">{t('labels.theme')}</span>
          <span className="text-primary dark:text-white capitalize">
            {layout?.theme || t('values.light')}
          </span>
        </div>
        <div className="flex justify-between items-center">
          <span className="text-foreground dark:text-gray-400">{t('labels.spacing')}</span>
          <span className="text-primary dark:text-white capitalize">
