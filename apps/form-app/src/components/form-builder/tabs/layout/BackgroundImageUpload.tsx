  ...
  return (
    <div className="space-y-2">
      <Button
        ...
        onClick={handleClick}
        disabled={loading}
        className="w-full p-4 h-auto border-2 border-dashed border-[rgba(81,76,84,0.15)] dark:border-gray-600 hover:border-purple-400 dark:hover:border-purple-500 bg-[#f7f7f8] dark:bg-gray-800 hover:bg-[#f7f7f8] dark:hover:bg-gray-700"
      >
        <div className="flex flex-col items-center space-y-2">
          {loading ? (
            <div className="w-6 h-6 border-2 border-purple-600 border-t-transparent rounded-full animate-spin" />
          ) : (
            <Plus className="w-6 h-6 text-[#655d67] dark:text-gray-400" />
          )}
          <span className="text-sm text-[#4c414e] dark:text-gray-400">
