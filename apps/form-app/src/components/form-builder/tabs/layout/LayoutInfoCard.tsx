      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-3">
          <div className="flex justify-between items-center py-2 px-3 bg-gray-50 dark:bg-gray-700 rounded">
            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Layout:</span>
          ...
          <div className="flex justify-between items-center py-2 px-3 bg-gray-50 dark:bg-gray-700 rounded">
            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Spacing:</span>
        ...
        <div className="flex items-center justify-center">
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 w-full">
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-2 text-center">Preview</p>
            <div className="text-xs text-gray-600 dark:text-gray-400 text-center">
              {getLayoutName(currentLayoutCode)} Layout
            </div>
          </div>
        </div>
      </div>
