      ...
      >
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            {permissions.canReorderPages() ? (
              <div
                ...
                className="flex-shrink-0 cursor-grab active:cursor-grabbing text-muted-foreground hover:text-foreground dark:hover:text-gray-300 transition-colors"
                onClick={(e) => e.stopPropagation()}
              >
                <GripVertical className="w-4 h-4" />
              </div>
            ) : (
              <div className="flex-shrink-0 text-[var(--tf-light-muted)] dark:text-gray-600">
                <GripVertical className="w-4 h-4" />
              </div>
            )}
            ...
            <div className="flex-1 min-w-0">
              ...
              {pageRuleCount > 0 && (
                <Badge
                  ...
                  className="gap-1 px-1.5 py-0 text-[10px] leading-4 mb-2 cursor-pointer hover:bg-accent"
                >
              ...
              <div className="space-y-1">
                {page.fields.length === 0 ? (
                  <div className="flex items-center justify-center py-1 text-muted-foreground dark:text-gray-600">
                  ...
                  <>
                    ...
                    {page.fields.length > 3 && (
                      <div className="text-xs text-muted-foreground dark:text-gray-400 text-right pt-0.5">
                        +{page.fields.length - 3}
                      </div>
                    )}
                  </>
          ...
          {isDraggingFromDifferentPage && (
            <div className="absolute inset-0 bg-primary/10 border-2 border-dashed border-primary/60 rounded-lg flex items-center justify-center z-10">
