      ...
      >
        ...
        <div className="flex items-center space-x-2 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="font-medium text-sm text-primary dark:text-white truncate">
              {page.title}
            </div>
        ...
        <div className="space-y-1.5">
          {page.fields.length === 0 ? (
            <div className="flex items-center justify-center py-4 text-muted-foreground dark:text-gray-600">
