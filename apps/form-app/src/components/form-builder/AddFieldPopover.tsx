  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          className="w-full h-12 border-2 border-dashed border-[var(--tf-border-strong)] dark:border-gray-600 hover:border-blue-400 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-950/20 transition-all duration-200"
      ...
      <PopoverContent className="w-80 p-0" align="start">
        <div className="p-4">
          <TypographyP className="font-medium text-sm mb-3">
            {t('chooseFieldType')}
          </TypographyP>

          {Object.entries(groupedFields).map(([category, fields]) => (
            <div key={category} className="mb-4 last:mb-0">
              <TypographyP className="text-xs font-medium text-muted-foreground dark:text-gray-400 uppercase tracking-wide mb-2">
