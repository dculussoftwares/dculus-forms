    ...
    <div 
      ...
      className={`flex-shrink-0 border-t p-4 space-y-4 transition-all duration-200 ${
        isDirty 
          ...
          : 'bg-white dark:bg-gray-900 border-[var(--tf-border-medium)] dark:border-gray-700'
      }`}>
      {/* Form Actions */}
      ...
      <div className={`text-xs pt-2 border-t transition-colors duration-200 ${
        isDirty 
          ...
          : 'text-muted-foreground dark:text-gray-400 border-gray-100 dark:border-gray-800'
      }`}>
        <div className="flex items-center justify-between">
