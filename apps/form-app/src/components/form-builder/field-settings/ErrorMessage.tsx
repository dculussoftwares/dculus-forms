...
const TranslatedErrorMessage: React.FC<{ namespace: string; translationKey: string }> = ({ namespace, translationKey }) => {
  ...
  return (
    <div className="flex items-center space-x-1 text-destructive dark:text-red-400 text-xs mt-1 p-2 bg-[var(--tf-error-bg)] dark:bg-red-900/20 border border-[var(--tf-error-bg-lg)] dark:border-red-800 rounded-lg animate-in slide-in-from-top-2 duration-200">
