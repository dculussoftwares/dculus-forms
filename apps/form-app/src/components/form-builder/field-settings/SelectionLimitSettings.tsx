  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="field-min-selections" className="text-xs font-medium text-foreground dark:text-gray-300">
          Minimum Selections
        </Label>
        <Controller
      ...
      <div className="space-y-2">
        <Label htmlFor="field-max-selections" className="text-xs font-medium text-foreground dark:text-gray-300">
          Maximum Selections
        </Label>
        <Controller
