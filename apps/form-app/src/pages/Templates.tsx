      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        {error && (
          <div className="text-center py-20">
            <div className="bg-[var(--tf-error-bg)] border border-[var(--tf-error-bg-lg)] rounded-lg p-6 max-w-md mx-auto">
              <div className="text-destructive font-medium mb-2">{t('status.errorTitle')}</div>
              <div className="text-destructive text-sm">{t('status.errorMessage')}</div>
            </div>
          </div>
        )}
        ...
        {!loading && !error && (
          <>
            {data?.templates?.length === 0 ? (
              <div className="text-center py-20">
                <div className="bg-background border border-[var(--tf-border-medium)] rounded-lg p-8 max-w-md mx-auto">
                  <div className="text-foreground font-medium mb-2">{t('status.emptyTitle')}</div>
                  <div className="text-muted-foreground text-sm">{t('status.emptyMessage')}</div>
                </div>
              </div>
            ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <p className="text-foreground text-sm mb-4 leading-relaxed" style={{
                          display: '-webkit-box',
                          WebkitLineClamp: 2,
