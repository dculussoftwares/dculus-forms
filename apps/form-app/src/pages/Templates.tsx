      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        {error && (
          <div className="text-center py-20">
            <div className="bg-[rgba(206,93,85,0.06)] border border-[rgba(206,93,85,0.16)] rounded-lg p-6 max-w-md mx-auto">
              <div className="text-[#ce5d55] font-medium mb-2">{t('status.errorTitle')}</div>
              <div className="text-[#ce5d55] text-sm">{t('status.errorMessage')}</div>
            </div>
          </div>
        )}
        ...
        {!loading && !error && (
          <>
            {data?.templates?.length === 0 ? (
              <div className="text-center py-20">
                <div className="bg-[#f7f7f8] border border-[rgba(81,76,84,0.10)] rounded-lg p-8 max-w-md mx-auto">
                  <div className="text-[#4c414e] font-medium mb-2">{t('status.emptyTitle')}</div>
                  <div className="text-[#655d67] text-sm">{t('status.emptyMessage')}</div>
                </div>
              </div>
            ) : (
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden">
                        {backgroundImageUrl ? (
                          ...
                          <div className="h-48 bg-gradient-to-br from-slate-100 via-slate-50 to-white flex items-center justify-center relative">
                            ...
                            <div className="text-[#655d67] text-center">
                      ...
                      <div className="p-6">
                        <div className="flex items-start justify-between mb-3">
                          <h3 className="text-lg font-semibold text-[#3c323e] group-hover:text-blue-600 transition-colors">
                            {template.name}
                          </h3>
                          {template.category && (
                        ...
                        <p className="text-[#4c414e] text-sm mb-4 leading-relaxed" style={{
                          display: '-webkit-box',
                          WebkitLineClamp: 2,
                        ...
                        <div className="flex items-center justify-between text-xs text-[#655d67]">
