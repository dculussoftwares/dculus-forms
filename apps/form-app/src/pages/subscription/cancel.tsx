    ...
    <div className="min-h-screen bg-background dark:bg-gray-900 flex items-center justify-center p-4">
      <Card className="max-w-2xl w-full p-8">
        ...
        <div className="flex justify-center mb-6">
          <div className="bg-background dark:bg-gray-800 rounded-full p-4">
            <XCircle className="h-16 w-16 text-foreground dark:text-gray-400" />
          </div>
        </div>
      ...
      {showUpgrade && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <Card className="max-w-md p-6 m-4">
            ...
            <p className="text-foreground dark:text-gray-400 mb-4">
              {t('modal.message')}
            </p>
