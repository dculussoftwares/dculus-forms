    ...
    >
      <div className="space-y-5">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <ChartCard icon={PieChart} iconBg="#ddd6fa" iconColor="#5c2e6b" title={t('charts.fieldAnalytics.title')} description={t('charts.fieldAnalytics.description')}>
            <div className="space-y-3">
              {[
                { label: t('charts.fieldAnalytics.nameFieldCompletion'), pct: 100, color: '#177767' },
                { label: t('charts.fieldAnalytics.emailFieldCompletion'), pct: 100, color: '#177767' },
        ...
        <div className="rounded-xl bg-white p-5" style={{ border: '1px solid rgba(81,76,84,0.10)', boxShadow: '0 1px 4px rgba(60,50,62,0.06)' }}>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              { value: '100%', label: t('charts.responseSummary.completionRate'), bg: '#ddd6fa', color: '#5c2e6b' },
