          ...
          <Card className="p-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-600 max-w-2xl mx-auto">
                You need to be logged in to view form analytics. Please sign in
                to access detailed insights about your form's performance.
              </p>
            </div>
          </Card>
        )}
            ...
            <div className="text-center">
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  ...
                  designed with privacy in mind. We collect only anonymous data
                  without storing personal information or IP addresses.
                </p>
              </div>
            </div>
          </Card>
