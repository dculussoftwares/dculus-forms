...
import type { FormSchema, FormLayout, LayoutCode } from '@dculus/types';
...
/**
 * LayoutTab component - Main layout customization interface
 * Provides visual form renderer with layout sidebar for theme/background controls
 */
