    ...
    return (
      <div className="min-h-screen bg-background dark:bg-gray-900 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-foreground dark:text-gray-400">Loading user details...</p>
        </div>
      </div>
    );
  }
          ...
          <CardContent className="p-8">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 text-foreground dark:text-gray-400 mb-3">
                ...
                <div className="flex items-center gap-2">
                  {user.emailVerified ? (
                    ...
                    <div className="flex items-center gap-1 px-3 py-1 bg-background dark:bg-gray-800 text-foreground dark:text-gray-400 rounded-full text-sm font-medium">
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-foreground dark:text-gray-400">User ID</p>
                  <p className="font-mono text-sm text-primary dark:text-gray-100">
                    {user.id}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-foreground dark:text-gray-400">Created</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-foreground dark:text-gray-400">Last Updated</p>
                  <p className="text-sm text-primary dark:text-gray-100">
            ...
            {user.organizations.length > 0 ? (
              <div className="space-y-3">
                {user.organizations.map((org) => (
                  <Card key={org.organizationId} className="border border-[var(--tf-border-medium)] dark:border-gray-700">
              ...
              <div className="text-center py-8">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-background dark:bg-gray-800 flex items-center justify-center">
                  <Building2 className="w-8 h-8 text-muted-foreground dark:text-gray-500" />
                </div>
