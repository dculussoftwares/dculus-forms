...
When('I make {int} consecutive health check requests', async function(count) {
...
Then('the response should contain success status', function() {
...
Then('the timestamp should be a valid ISO date', function() {
...
Then('the timestamp should be recent', function() {
...
Then('the uptime should be greater than {int}', function(minUptime) {
...
Then('all responses should have success status {word}', function(expectedValue) {
  const expected = expectedValue === 'true';
...
Then('each uptime should be greater than or equal to the previous uptime', function() {
