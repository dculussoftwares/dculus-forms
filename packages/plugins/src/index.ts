...
export { microsoftSheetsManifest } from './manifests/microsoft-sheets.js';
...
import { microsoftSheetsManifest } from './manifests/microsoft-sheets.js';
