...
export const L7SingleLayout: React.FC<LayoutProps> = ({
  ...
  const handleContentChange = (content: string) => {
    ...
    setHasUnsavedChanges(content !== (layout?.content || '<h1>Single Layout</h1><p>Clean single-section design with information panel and form section.</p>'));
  };
  ...
  const handleCancel = () => {
    const originalContent = layout?.content || '<h1>Single Layout</h1><p>Clean single-section design with information panel and form section.</p>';
  ...
  React.useEffect(() => {
    if (!hasUnsavedChanges) {
      setTempContent(layout?.content || '<h1>Single Layout</h1><p>Clean single-section design with information panel and form section.</p>');
          ...
          >
            ...
            <div className="h-full flex items-center justify-center relative z-10" style={{ padding: '5% 10%' }}>
              ...
              <div className="w-full h-full relative rounded-lg overflow-hidden shadow-xl">
                ...
                {/* Single chunk layout - full width */}
                        ...
                        <div className="flex-1 flex items-start justify-center overflow-y-auto">
                          <div className="w-full max-w-2xl my-auto">
                            <LexicalRichTextEditor
                              ...
                              placeholder="Enter your single layout content..."
