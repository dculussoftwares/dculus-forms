...
export const L3CardLayout: React.FC<LayoutProps> = ({
  ...
  const getLayoutStyles = () => ({
    field: {
      ...
      input: 'w-full h-10 bg-gray-50 dark:bg-gray-700 rounded-md px-3 text-gray-500',
      textarea: 'w-full h-24 bg-gray-50 dark:bg-gray-700 rounded-md px-3 py-2 text-gray-500',
      select: 'w-full h-10 bg-gray-50 dark:bg-gray-700 rounded-md px-3 text-gray-500',
    },
