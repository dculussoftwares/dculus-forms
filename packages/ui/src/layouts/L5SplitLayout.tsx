...
export const L5SplitLayout: React.FC<LayoutProps> = ({
  ...
  // L5 Split layout styles
  const getLayoutStyles = () => ({
    field: {
      container: 'mb-6',
      label: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2',
      input: 'w-full h-12 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-4 text-gray-500',
      textarea: 'w-full h-24 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-3 text-gray-500',
      select: 'w-full h-12 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-4 text-gray-500',
    },
  ...
  const handleContentChange = (content: string) => {
    ...
    setHasUnsavedChanges(content !== (layout?.content || '<h1>Split Layout</h1><p>Left-right split design with information panel and form section.</p>'));
  };
  ...
  const handleCancel = () => {
    const originalContent = layout?.content || '<h1>Split Layout</h1><p>Left-right split design with information panel and form section.</p>';
  ...
  React.useEffect(() => {
    if (!hasUnsavedChanges) {
      setTempContent(layout?.content || '<h1>Split Layout</h1><p>Left-right split design with information panel and form section.</p>');
                        ...
                        <div className="flex-1 flex items-start justify-center overflow-y-auto">
                          <div className="w-full max-w-sm my-auto">
                            <LexicalRichTextEditor
                              ...
                              placeholder="Enter your split layout content..."
